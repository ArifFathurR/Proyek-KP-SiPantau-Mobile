...
class KegiatanSayaPml : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        kegiatanAdapter = KegiatanAdapter(
            ...
            onItemClick = { kegiatan ->
                val idPml = kegiatan.id_pml
                val idDetail = kegiatan.id_kegiatan_detail_proses

                if (idPml != null) {
                    val intent = Intent(this, PantauAktivitasLaporanPml::class.java)
        ...
        binding.rvKegiatan.apply {
            layoutManager = LinearLayoutManager(this@KegiatanSayaPml)
