...
class ProgresPertanianAdapter(
    private var list: List<ProgresPertanianEntity>,
    private val onDeleteClick: ((ProgresPertanianEntity) -> Unit)? = null
) : RecyclerView.Adapter<ProgresPertanianAdapter.ViewHolder>() {
        ...
        with(holder.binding) {
            ...
            root.setOnClickListener {
                ...
                val intent = Intent(context, DetailProgresActivity::class.java).apply {
                    ...
                    // khusus lapor pertanian
                    putExtra("is_lapor_pertanian", true)
                }
    ...
    fun updateData(newData: List<ProgresPertanianEntity>) {
        list = newData
