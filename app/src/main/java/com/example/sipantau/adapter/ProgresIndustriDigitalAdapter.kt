...
class ProgresIndustriDigitalAdapter(
    private var list: List<ProgresIndustriDigitalEntity>,
    private val onDeleteClick: ((ProgresIndustriDigitalEntity) -> Unit)? = null
) : RecyclerView.Adapter<ProgresIndustriDigitalAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        with(holder.binding) {
            ...
            tvDetailProgress3.visibility = View.GONE
            tgl.text =
            ...
            root.setOnClickListener {
                ...
                val intent = Intent(context, DetailProgresActivity::class.java).apply {
                    ...
                    // khusus industri digital (tidak ada id_pcl)
                    putExtra("is_industri_digital", true)
                }
    ...
    fun updateData(newData: List<ProgresIndustriDigitalEntity>) {
        list = newData
